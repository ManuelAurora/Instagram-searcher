...
class FeedTableViewController: UITableViewController
{
    ...
    @IBOutlet weak var _userPosts: UILabel?
    @IBOutlet weak var _userFollowers: UILabel?
    @IBOutlet weak var _userFollowing: UILabel?
    @IBOutlet weak var _profileView: UIView?
